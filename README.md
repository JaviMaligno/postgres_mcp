...
[![PyPI version](https://badge.fury.io/py/mcp-server-postgres.svg)](https://pypi.org/project/mcp-server-postgres/)
...
mcp-server-postgres  # Should wait for MCP messages
```

## Links

- [PyPI Package](https://pypi.org/project/mcp-server-postgres/)
